...
class FinalizeOAuthInputSet(InputSet):
    ...
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((required, string) The OAuth 2.0 Client ID provided by Fitbit.)
        """
    ...
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((optional, string) Deprecated (retained for backward compatibility only).)
        """
        super(FinalizeOAuthInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((optional, string) Deprecated (retained for backward compatibility only).)
        """
        super(FinalizeOAuthInputSet, self)._set_input('ConsumerSecret', value)
    def set_OAuthTokenSecret(self, value):
        """
        Set the value of the OAuthTokenSecret input for this Choreo. ((optional, string) Deprecated (retained for backward compatibility only).)
        """
...
class FinalizeOAuthResultSet(ResultSet):
    ...
    def get_UserID(self):
        """
        Retrieve the value for the "UserID" output from this Choreo execution. ((string) Deprecated (retained for backward compatibility only).)
        """
