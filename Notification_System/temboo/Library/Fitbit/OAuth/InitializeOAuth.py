...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_Scope(self, value):
        """
        Set the value of the Scope input for this Choreo. ((required, string) A space-delimited list of the permissions you are requesting. See Choreo notes for a list of valid values for this input.)
        """
